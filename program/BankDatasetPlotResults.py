import BankDatasetTesting
import matplotlib.pyplot as plt

def plotResults():
    r1, r2, r3, acc = BankDatasetTesting.getResults()
    r1v, r2v, r3v, accv = BankDatasetTesting.getResultsVoted()
