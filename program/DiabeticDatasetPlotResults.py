import DiabeticDatasetTesting
import matplotlib.pyplot as plt

def plotResults():
    # getting results
    r1, r2, r3, acc = DiabeticDatasetTesting.getResults()
    r1v, r2v, r3v, accv = DiabeticDatasetTesting.getResultsVoted()
